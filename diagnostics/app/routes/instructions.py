...
@instructions_bp.route('/', methods=['GET'])
...
@instructions_bp.route('/<string:instruction_id>', methods=['GET'])
...
@instructions_bp.route('/failure/<string:failure_name>', methods=['GET'])
...
@instructions_bp.route('/<string:instruction_id>', methods=['PUT'])
...
@instructions_bp.route('/<string:instruction_id>', methods=['DELETE'])
